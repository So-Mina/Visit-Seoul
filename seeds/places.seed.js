...
const MONGO_URI =
  process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/visit-seoul'
...
const places = [
  ...
  smallDescription: 'Gyeongbokgung (Korean: 경복궁), also known as Gyeongbokgung Palace or Gyeongbok Palace, was the main royal palace of the Joseon dynasty.',
...
}, 
{
  ...
  area: 'Jongno-gu / Insadong',
  smallDescription: 'Bukchon Hanok Village is a Korean traditional village in Seoul with a long history located on the top of a hill between Gyeongbok Palace, Changdeok Palace and Jongmyo Royal Shrine.',
  ...
  recommended: true,
  location: { 
    coordinates: [37.5814696,126.9827579] }
  // openningHours: none,
...
}, 
{
  ...
  smallDescription:'The Dongdaemun Design Plaza, abbreviated as DDP, is a major urban development landmark in Seoul, South Korea, designed by Zaha Hadid and Samoo, with a distinctively neofuturistic design characterized by the "powerful, curving forms of elongated structures."',
  ...
  recommended: true,
  location: { 
    coordinates: [37.5671298,127.0095558] }
  // openningHours: [{String}],
  // officialWebsite: none, 
  // displayMap: String,  
}, 
{
  ...
  area: 'Jung-gu / Dongdaemun',
  smallDescription:'Cheonggyecheon (Korean: 청계천) is a 10.9-kilometre-long (6.8 mi) modern public recreation space in downtown Seoul, South Korea.',
  ...
  recommended: true,
  location: { 
    coordinates: [37.5691015,126.9764752] }
  // openningHours: none,
  // officialWebsite: none; 
  // displayMap: String, 
}, 
{
  name: 'Myeongdong Main shopping Street And Area',
  ...
  smallDescription:"Myeongdong (Korean: 명동; lit. 'bright cave' or 'bright tunnel') is a dong in Jung-gu, Seoul, South Korea between Chungmu-ro, Eulji-ro, and Namdaemun-ro.",
  ...
  recommended: true,
  location: { 
    coordinates: [37.5625053,126.9833128] }
  // openningHours: none,
  // officialWebsite: none, 
  // displayMap: String, 
}, 
{
  ...
  smallDescription:'The N Seoul Tower (Korean: N 서울타워), officially the YTN Seoul Tower and commonly known as Namsan Tower or Seoul Tower, is a communication and observation tower located on Nam Mountain in central Seoul, South Korea.',
  ...
  recommended: true,
  location: { 
    coordinates: [37.5546144,126.9847011] }
  // openningHours: [{String}],
...
}, 
{
  ...
  smallDescription:"Itaewon (Korean: 이태원) is multi-cultural commercial area located in Seoul, South Korea.",
  ...
  recommended: true,
  location: { 
    coordinates: [37.5343325,126.9935917] }
  // openningHours: none,
  // officialWebsite: none, 
  // displayMap: String, 
}, 
{
  ...
  smallDescription:"The Banpo Bridge (Korean: 반포대교) is a major bridge in downtown Seoul over the Han River, South Korea, connecting the Seocho and Yongsan districts.",
  ...
  recommended: true,
  location: { 
    coordinates: [37.51416,126.996177] }
  // openningHours: none,
  // officialWebsite: none, 
  // displayMap: String, 
},
{
  ...
  area: 'Gangnam-gu',
  smallDescription:"The COEX Aquarium in Gangnam district, Seoul, is one of South Korea's Public Aquariums.",
  ...
  recommended: true,
  location: { 
    coordinates: [37.513131,127.0560887] }
  // openningHours: [{String}],
...
},
{
  ...
  area:'Seodaemun-gu',
  smallDescription:"Seodaemun Prison History Hall is a museum and former prison in Seodaemun-gu, Seoul, South Korea.",
  ...
  recommended: true,
  location: { 
    coordinates: [37.574271,126.953877] }
  // openningHours: [{String}],
...
},
{
  ...
  area: 'Mapo-gu',
  smallDescription:"Hongdae (Korean: 홍대) is a neighborhood in Seoul, South Korea near Hongik University, after which it is named.",
  ...
  recommended: true,
  location: { 
    coordinates: [37.5531707,126.9197002] }
  // openningHours: none,
  // officialWebsite: none, 
  // displayMap: String, 
},  
{
  ...
  smallDescription:"Lotte World is a major recreation complex in Seoul, South Korea.",
  ...
  recommended: true,
  location: { 
    coordinates: [37.5124159,127.0972919] }
  // openningHours: [{String}],
...
{
  name: 'Tongin Market',
  photo: 'https://tongglobalcdn.visitkorea.or.kr/cms/resource/61/2932661_image2_1.bmp',
  address: '18 Jahamun-ro 15-gil',
  area: 'Jongno-gu',
  smallDescription:"Traditional Korean Market where you can eat delicious food",
  description: `Traditional Korean Market where you can eat delicious food`,
  recommended: true,
  location: { 
    coordinates: [37.5807649,126.9684869] }
  // openningHours: [{String}],
  // officialWebsite: https://adventure.lotteworld.com/eng/main/index.do, 
  // displayMap: String, 
},
{
  name: 'Yongma Land',
  photo: 'https://upload.wikimedia.org/wikipedia/en/9/9c/Entrance_of_Yongma_Land.jpg',
  address: '118 Mangu-ro 70-gil',
  area: 'Jungnang-gu / Yongmasan',
  smallDescription:"Yongma Land opened in 1980 as a family-friendly amusement park.",
  ...
  recommended: true,
  location: { 
    coordinates: [37.5926373,127.1007225] }
  // openningHours: [{String}],
  // officialWebsite: https://adventure.lotteworld.com/eng/main/index.do, 
  // displayMap: String, 
}
